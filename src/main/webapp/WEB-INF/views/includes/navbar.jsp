...
<header>
	<div class="sidebar">
			...
			<div class="ifstatement">
				<c:choose>
					<c:when test="${user == null}">
						<p><i class="javaFunctionText">if</i>(<span class=javaConstantText">userExist</span>){</p>
						<div class="ifcase">	
		...
		<div class="sidebarCode">
			<div class="forloop">
				<p><i class="javaFunctionText">for</i>(<i class="javaTypeText">String</i> category : <span class="javaConstantText">EISTI</span>){</p>
				<div class="switch">
